...
import '../widgets/storage/database_tab.dart';
import '../widgets/storage/prefs_tab.dart';
...
class _StorageScreenState extends State<StorageScreen>
  ...
  void _refresh() {
    setState(() {});
    final which = _tab.index == 0 ? 'SharedPrefs' : 'Database';
    DebugToast.show(
      context,
      '$which refreshed',
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [Tab(text: 'SharedPrefs'), Tab(text: 'Database')],
        ),
      ),
      body: TabBarView(
        controller: _tab,
