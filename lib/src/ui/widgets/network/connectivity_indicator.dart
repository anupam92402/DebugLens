    ...
    switch (r) {
      case ConnectivityResult.wifi:
        return const _IndicatorVisual(
            Icons.wifi, DebugPalette.success, 'Wi-Fi');
      case ConnectivityResult.mobile:
        return const _IndicatorVisual(
            Icons.signal_cellular_alt, DebugPalette.info, 'Mobile data');
      case ConnectivityResult.ethernet:
        return const _IndicatorVisual(
            Icons.lan, DebugPalette.info, 'Ethernet');
      case ConnectivityResult.vpn:
        return const _IndicatorVisual(
            Icons.vpn_lock, DebugPalette.warning, 'VPN');
      case ConnectivityResult.bluetooth:
        return const _IndicatorVisual(
            Icons.bluetooth, DebugPalette.info, 'Bluetooth');
      case ConnectivityResult.other:
        return const _IndicatorVisual(
            Icons.device_hub, DebugPalette.textMuted, 'Other');
      case ConnectivityResult.none:
        return const _IndicatorVisual(
            Icons.signal_wifi_off, DebugPalette.error, 'Offline');
      case null:
        return const _IndicatorVisual(
            Icons.help_outline, DebugPalette.textMuted, 'Checking…');
    }
  }
}
